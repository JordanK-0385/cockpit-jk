...
function AmbientOrbsBase() {
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden" aria-hidden="true">
      {/* sage — top right */}
      <div
        className="orb absolute -top-[15%] -right-[10%] h-[55vmax] w-[55vmax] rounded-full animate-orb-1 mix-blend-screen"
        style={{
          background:
      ...
      {/* glacier — bottom left */}
      <div
        className="orb absolute -bottom-[20%] -left-[10%] h-[60vmax] w-[60vmax] rounded-full animate-orb-2 mix-blend-screen"
        style={{
          background:
      ...
      {/* gold — center */}
      <div
        className="orb absolute top-[35%] left-[40%] h-[40vmax] w-[40vmax] rounded-full animate-orb-3 mix-blend-screen"
        style={{
          background:
      ...
      <div
        className="orb absolute top-[25%] right-[20%] h-[35vmax] w-[35vmax] rounded-full animate-orb-4 mix-blend-screen"
        style={{
          background:
